...
```bash
python examples/sefia/main.py --topic "The impact of generative AI on software development"
```
...
> Stage 1: Researching topic...
   -> WebSearchTool: Searching for 'impact of generative AI on software development'...
...
python examples/sefia/main.py --session-id "a1b2c3d4-..." --answer "Your answer"
---
```

### 3. Resume the Workflow

Use the provided `session-id` and add your answer to resume the process.

```bash
python examples/sefia/main.py --session-id "a1b2c3d4-..." --answer "Please add a section about the potential risks, like code quality and security vulnerabilities."
```
...
> Stage 2: Writing article...
   -> HumanInputTool: Got user answer: 'Please add a section about the potential risks, like code quality and security vulnerabilities.'
...
Sources: ['https://example.com/source/gen_ai_dev_1', 'https://example.com/source/gen_ai_dev_2']
--------------------
> Workflow complete.
```
