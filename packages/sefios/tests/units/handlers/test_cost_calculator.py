...
class TestCostCalculator:
    ...
    async def test_calculates_and_saves_cost(self, mock_state_store):
    ...
    async def test_accumulates_cost(self, mock_state_store):
    ...
    async def test_ignores_event_without_cost_info(self, mock_state_store):
        handler = CostCalculator()
